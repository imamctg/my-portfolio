...
const processIconOptions = [
  { value: 'FaHandshake', label: 'Discovery & Planning' },
  { value: 'FaSearch', label: 'Research / Audit' },
  { value: 'FaPalette', label: 'UI/UX Design' },
  { value: 'FaCode', label: 'Development' },
  { value: 'FaBug', label: 'Testing & QA' },
  { value: 'FaRocket', label: 'Deployment / Launch' },
  { value: 'FaTools', label: 'Maintenance / Support' },
  { value: 'FaClock', label: 'Timeline / Duration' },
]
